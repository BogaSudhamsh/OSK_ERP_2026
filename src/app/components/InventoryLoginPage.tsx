...
export const InventoryLoginPage: React.FC<InventoryLoginPageProps> = ({ onBack, onLogin }) => {
  const [email, setEmail] = useState('inventory@oskgranite.com');
          ...
          <div className="rounded-2xl border border-[#D4AF37]/15 bg-[#151310]/80 backdrop-blur-xl shadow-[0_0_80px_-20px_rgba(212,175,55,0.08)] p-7 lg:p-9">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <Label htmlFor="inv-email" className="text-[#C9A961] text-sm" style={{ fontWeight: 500 }}>
                  Email Address
                </Label>
                <Input
                  id="inv-email"
                  type="email"
                  placeholder="inventory@oskgranite.com"
                  value={email}
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label htmlFor="inv-password" className="text-[#C9A961] text-sm" style={{ fontWeight: 500 }}>
                    Password
                  </Label>
